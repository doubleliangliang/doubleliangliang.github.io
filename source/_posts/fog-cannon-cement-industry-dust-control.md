---
title: >-
  Fog Cannon Applications in the Cement Industry: Dust Control from Quarry to
  Packing Plant
date: 2026-09-23 10:52:38
tags:
  - Cement Industry
  - Dust Suppression
  - Fog Cannon
...
Cement is the third-largest industrial source of air pollutant emissions in China, behind power generation and steel. That ranking is the reason the *Opinions on Promoting Ultra-Low Emission in the Cement Industry*, issued on 19 January 2024 by the Ministry of Ecology and Environment together with the National Development and Reform Commission, the Ministry of Industry and Information Technology, the Ministry of Finance and the Ministry of Transport, arrived with a calendar attached rather than an aspiration.

The timetable is a ramp: by the end of 2025, key air-quality regions were to have made obvious progress, with 50 percent of clinker capacity retrofitted and large state-owned groups in those regions essentially complete on both organised and fugitive sources; by the end of 2028, clinker producers in key regions should be substantially finished and the country as a whole is aiming for 80 percent of clinker capacity. The concentration limits are the familiar ones — at the kiln and the waste-heat recovery system, and at a reference oxygen content of 10 percent, hourly averages for particulate matter, sulphur dioxide and nitrogen oxides are capped at 10, 35 and 50 mg/m3.

None of that is the hard part. By 2024 the cement industry had already spent two decades on kiln-line dedusting; bag filters and electrostatic precipitators at the stack are mature, well-vendored and continuously monitored. The hard part is the sentence in the same document that has no number in it at all: dust-generating points and production facilities must show **no visible dust or fume escaping**, and the plant must be **tidy, with no accumulated dust**. That is a visual criterion. It is assessed by looking, and increasingly by cameras.

<!-- more -->

## Where Cement Dust Actually Comes From

A cement plant is not one dust problem. It is eight or nine, running in series, and they behave so differently that a single measure applied across the site is guaranteed to be wrong somewhere.

![Cement plant dust source map from limestone quarry and crushing through pre-homogenising yard, raw mill, kiln line, clinker handling, cement mill and packing plant, with the matching suppression measure at each stage](/images/cement-plant-dust-source-map.svg)

The process chain is well known. Limestone and clay are drilled and blasted in the quarry, loaded and hauled to a crusher, stockpiled for pre-homogenising, ground and blended into raw meal, preheated and calcined in the kiln, cooled into clinker, ground again with gypsum and supplementary materials into cement, and finally dispatched either in bulk or in bags. Coal arrives as a separate stream and is ground for the kiln's fuel.

Every one of those transitions is a dust source, and the sources fall into four groups that behave nothing alike.

| Source | Dust character | What it needs |
| --- | --- | --- |
| Quarry: drilling, blasting, loading, haul roads | Coarse, intermittent, huge open area, wind and vehicle driven | Reach and coverage: long-range fog cannon, road hardening, sweeping |
| Crushing station and transfer to the yard | High concentration, coarse to medium, localised but severe | Enclosed chute and hood first, cannon or fixed spray for the apron |
| Pre-homogenising yard (stacker and reclaimer) | Wide, low plume, strongly wind-driven, coarse to medium | Long-range fog cannon with wind-aware presets; sealing where possible |
| Coal yard and coal mill | Combustible dust with a genuine explosion hazard, plus self-heating risk | Ex configurations to suit the site, routine housekeeping, CO and temperature monitoring — never dry sweeping or air-blasting |
| Raw mill, elevators, transfer points, raw meal silo top | Very fine, sticky, moist, easily re-entrained; builds up on walls | Dry fog and micro-mist with minimal added water; enclosure plus local dedusting |
| Kiln, preheater and waste-heat recovery | High temperature, fine, always moving, strongly buoyant | Capture and bag filtration. This is an organised source, not a spray job |
| Clinker cooler, clinker silo and clinker transport | Hot, coarse, heavily abrasive | Enclosure at transfer points, cannon for open stockpiles, wear-resistant nozzles |
